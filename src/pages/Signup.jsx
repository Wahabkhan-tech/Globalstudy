...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const result = signup(email, password, formData.role, fullName);
    if (result.success) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50 font-sans flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full border border-gray-100">
        ...
        <h3 className="text-xl font-semibold text-indigo-700 mb-6 text-center">Sign Up</h3>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="media_channel">Media Channel</option>
